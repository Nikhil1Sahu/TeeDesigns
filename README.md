...
TeeDesigns is a simple, responsive web project designed to showcase customizable T-shirts using basic web technologies like HTML, CSS, and JavaScript. This project features a clean and intuitive interface where users can explore various T-shirt designs with interactive image switching, built using JavaScript.
